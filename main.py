        ...
        try:
            ...
            if snapshot.next:
                 ...
                 # [V3 Fix] Verifier 现在跳转到 Observer，所以 next_node 是 Observer
                     ...
                     verification = snapshot.values.get("verification_result", {})
                     if verification:
                         ...
                         if is_success:
                             print(f"   ✅ Verification Passed: {summary[:100]}...")
                         else:
                             print(f"   ❌ Verification Failed: {summary[:100]}...")
                         ...
                         if user_override == "s":
                             ...
                             app.update_state(config, {"verification_result": {}}, as_node="Observer")
